...
namespace EFCoreGenericRepository.Console.RepositoryBase.GenericRepository
{
    internal class Repository<TDbContext> : QueryRepository<TDbContext>, IRepository<TDbContext>
